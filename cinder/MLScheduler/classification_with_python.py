...
class ClassificationWithPython:
    ...
    def create_models(self, training_dataset_size):
        # this method is not used, since the java service will do the machine learning part
    ...
    def predict_with_python_machine_learning_implimentation(self, clock, volume_request_id):
        # this method is not used, since the java service will do the machine learning part
